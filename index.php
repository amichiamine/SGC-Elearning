...
require_once CORE_PATH . '/Controller.php'; // Requis car les autres classes peuvent en dépendre
...
// Les services sont enregistrés comme singletons pour garantir une instance unique par requête.
...
$container->singleton(SGC\Core\Router::class, function ($c) {
    // Le routeur a besoin du conteneur pour instancier les contrôleurs
